...
InitGraphics( )
{
	...
	MyVertexDataBuffer = VkuLoadObjFile((char *)"dino.obj");
	...
	ScaleXYZ.AddTimeValue(4.0f, 0.5f);
	ScaleXYZ.AddTimeValue(8.0f, 0.25f);
	ScaleXYZ.AddTimeValue(12.0f, 0.5f);
	ScaleXYZ.AddTimeValue(16.0f, 1.f);
	ScaleXYZ.AddTimeValue(20.0f, 1.25f);
	ScaleXYZ.AddTimeValue(24.0f, 1.5f);
	ScaleXYZ.AddTimeValue(28.0f, 1.25f);
	ScaleXYZ.AddTimeValue(32.0f, 1.f);

	ThetaX.AddTimeValue(0.0f, 0.0f);
	ThetaX.AddTimeValue(4.0f, glm::radians(180.f));
	ThetaX.AddTimeValue(8.0f, glm::radians(0.f));
	ThetaX.AddTimeValue(12.0f, glm::radians(-180.f));
	ThetaX.AddTimeValue(16.0f, glm::radians(0.f));
	ThetaX.AddTimeValue(20.f, glm::radians(360.f));
	ThetaX.AddTimeValue(24.f, glm::radians(0.f));
	ThetaX.AddTimeValue(28.f, glm::radians(-360.f));
	ThetaX.AddTimeValue(32.f, glm::radians(0.f));

	ThetaY.AddTimeValue(0.0f, 0.0f);
	ThetaY.AddTimeValue(4.0f, glm::radians(720.f));
	ThetaY.AddTimeValue(8.0f, glm::radians(0.f));
	ThetaY.AddTimeValue(12.0f, glm::radians(-720.f));
	ThetaY.AddTimeValue(16.0f, glm::radians(0.f));
	ThetaY.AddTimeValue(20.0f, glm::radians(90.f));
	ThetaY.AddTimeValue(24.0f, glm::radians(0.f));
	ThetaY.AddTimeValue(28.0f, glm::radians(-90.f));
	ThetaY.AddTimeValue(32.f, glm::radians(0.f));

	Xpos.AddTimeValue(0.0f, 0.0f);
	Xpos.AddTimeValue(4.0f, 10.0f);
	Xpos.AddTimeValue(8.0f, 0.0f);
	Xpos.AddTimeValue(12.0f, -10.0f);
	Xpos.AddTimeValue(16.0f, 0.0f);
	Xpos.AddTimeValue(20.0f, 10.0f);
	Xpos.AddTimeValue(24.0f, 0.0f);
	Xpos.AddTimeValue(28.0f, -10.0f);
	Xpos.AddTimeValue(32.0f, 0.0f);

	Ypos.AddTimeValue(0.0f, 0.0f);
	Ypos.AddTimeValue(4.0f, 5.0f);
	Ypos.AddTimeValue(8.0f, 0.0f);
	Ypos.AddTimeValue(12.0f, -5.0f);
	Ypos.AddTimeValue(16.0f, 0.0f);
	Ypos.AddTimeValue(20.0f, 5.0f);
	Ypos.AddTimeValue(24.0f, 0.0f);
	Ypos.AddTimeValue(28.0f, -5.0f);
	Ypos.AddTimeValue(32.0f, 0.0f);

	Shiny.AddTimeValue(0.0f, 32.f);
	Shiny.AddTimeValue(4.0f, 16.f);
	Shiny.AddTimeValue(8.0f, 0.0f);
	Shiny.AddTimeValue(12.0f, 16.f);
	Shiny.AddTimeValue(16.0f, 32.f);
	Shiny.AddTimeValue(20.0f, 16.f);
	Shiny.AddTimeValue(24.0f, 0.0f);
	Shiny.AddTimeValue(28.0f, 16.f);
	Shiny.AddTimeValue(32.0f, 32.f);
}
...
UpdateScene( )
{
	...
	Object.uModel = glm::translate(Object.uModel, glm::vec3(Xpos.GetValue(time), Ypos.GetValue(time), 0.f));

	Object.uNormal = glm::mat4(glm::inverseTranspose(glm::mat3(Scene.uSceneOrient*Object.uModel)));
	Object.uColor = glm::vec4( 1.f, 0.f, 0.f, 1.f );
	Object.uShininess = Shiny.GetValue(time);
