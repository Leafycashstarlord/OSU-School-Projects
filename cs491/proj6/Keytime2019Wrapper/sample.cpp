...
const char *WINDOWTITLE = { "Keytime Animation Demo -- Jackson Rollins" };
...
int	ObjectList1;		// list to hold the object
int ObjectList2;
...
Display( void )
{
	...
	float xpos1 = Xpos1.GetValue( nowTime );
	...
	glPushMatrix( );
		...
		glRotatef( ay,  0., 1., 0. );
		glRotatef( az,  0., 0., 1. );
		glCallList( ObjectList1 );
	glPopMatrix( );
	glPushMatrix( );
		glTranslatef( xpos1, ypos, zpos );
		glRotatef( -ax,  1., 0., 0. );
		glRotatef( -ay,  0., 1., 0. );
		glRotatef( -az,  0., 0., 1. );
		glCallList( ObjectList2 );
	glPopMatrix( );
...
void AddKeyframe(float time, float x, float x1, float y, float z, float thetaX, float thetaY, float thetaZ) {
	Xpos.AddTimeValue(time, x);
	Xpos1.AddTimeValue(time, x1);
	Ypos.AddTimeValue(time, y);
	Zpos.AddTimeValue(time, z);
...
InitGraphics( void )
{
	...
	AddKeyframe(0.f, 500.f, 500.f, 0.f, 0.f, 0.f, 0.f, 0.f);
	AddKeyframe(1.25f, 1000.f, 0.f, 250.f, 500.f, 22.5f, 90.f, 45.f);
	AddKeyframe(2.5f, 500.f, 500.f, 500.f, 1000.f, 45.f, 180.f, 90.f);
	AddKeyframe(3.75f, 0.f, 1000.f, 750.f, 500.f, 67.5f, 270.f, 135.f);
	AddKeyframe(5.f, 500.f, 500.f, 1000.f, 0.f, 90.f, 360.f, 180.f);
	AddKeyframe(6.25f, 1000.f, 0.f, 750.f, 500.f, 112.5f, 450.f, 225.f);
	AddKeyframe(7.5f, 500.f, 500.f, 500.f, 1000.f, 135.f, 540.f, 270.f);
	AddKeyframe(8.75f, 0.f, 1000.f, 250.f, 500.f, 157.5f, 630.f, 315.f);
	AddKeyframe(10.f, 500.f, 500.f, 0.f, 0.f, 180.f, 720.f, 360.f);
}
...
InitLists( void )
{
	...
	ObjectList1 = glGenLists( 1 );
	glNewList( ObjectList1, GL_COMPILE );
	...
	ObjectList2 = glGenLists( 1 );
	glNewList( ObjectList2, GL_COMPILE );
		glMaterialfv( GL_BACK, GL_AMBIENT, MulArray3( .4f, White ) );
		glMaterialfv( GL_BACK, GL_DIFFUSE, MulArray3( 1., White ) );
		glMaterialfv( GL_BACK, GL_SPECULAR, Array3( 0., 0., 0. ) );
		glMaterialf ( GL_BACK, GL_SHININESS, 5.f );
