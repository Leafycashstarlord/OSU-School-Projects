...
public:
	...
	int maxFunc(int &row, int&col, char playerSym, OthelloBoard *b);

	int minFunc(int &row, int&col, char playerSym, OthelloBoard *b);

	std::vector<OthelloBoard*> successor(char playerSym, OthelloBoard *b);
