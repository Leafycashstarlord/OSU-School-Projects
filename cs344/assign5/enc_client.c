...
//Main function that runs the encryption client
int main(int argc, char *argv[]) {
    ...
    FILE* ptFile;
    FILE* ktFile;
    char message[140000], plainText[70000], recBuff[70000], keyText[70000];
    char mLENGTH[1024];
    int msgLength;
    ...
    if(validation(plainText) < 0){
        perror("CLIENT: ERROR invalid plaintext");
        exit(EXIT_FAILURE);
    }
