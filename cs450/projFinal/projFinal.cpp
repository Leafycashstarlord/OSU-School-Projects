...
Animate( )
{
	...
	const int MS_IN_THE_ANIMATION_CYCLE = 50000;	// milliseconds in the animation loop
...
Display( )
{
	...
	xyz lightZeroPos = { 0.6, 0.6, 0 };
	glPushMatrix();
	glTranslatef(lightZeroPos.x, lightZeroPos.y, lightZeroPos.z);
	glColor3f(1, 1, 1);
	...
	glRotatef(-sin(80 * Time) * 30 - 20, 0, 0, 1);
	glRotatef(60, 0, 0, 1);
	glTranslatef(0, 1, 0);
