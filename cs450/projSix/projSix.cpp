...
Display( )
{
	...
	*/
	...
	{
		//starting point
		struct Point pt0 = { -1, 0, 0 };
		//initialize pt1
		struct Point pt1 = { -0.25, 1 ,0 };
		//initialize pt2
		struct Point pt2 = { 0.25, 1 ,0 };
		//initialize pt3
		struct Point pt3 = { 1, 0 ,0 };
	...
	for (int i = 0; i < NUMCURVES; i++)
	{
		//starting point
		struct Point pt0 = { -1, 0, 0 };
		struct Point pt1 = { 3 * sin(i / NUMCURVES * Time * 50), 1 ,-3 * sin(i / NUMCURVES * Time) };
		//initialize pt2
		struct Point pt2 = { 1.5 * cos(i / NUMCURVES * Time), sin(i * NUMCURVES) ,2.5 * cos(i / NUMCURVES * Time * 50) };
		//initialize pt3
	...
	for (int i = 0; i < NUMCURVES; i++)
	{
		...
		struct Point pt1 = { 3 * sin(i / NUMCURVES * Time * 50), 1 ,-3 * sin(i / NUMCURVES * Time) };
		//initialize pt2
		struct Point pt2 = { 1.5*cos(i / NUMCURVES * Time), sinf(i * NUMCURVES) ,2.5 * cos(i / NUMCURVES * Time * 50) };
		//initialize pt3
		struct Point pt3 = { 2 * sin(Time * 60), 0 ,-2 * cos(i / NUMCURVES * Time) };
